...
def test_pyproject_exposes_installable_console_script() -> None:
    ...
    assert data["project"]["scripts"]["wa-business-collector"] == "wa_business_collector.cli:main"
...
def test_packaged_assets_include_chrome_devtools_helper() -> None:
    ...
    assert "assets/chrome_devtools.mjs" in data["tool"]["setuptools"]["package-data"]["wa_business_collector"]
