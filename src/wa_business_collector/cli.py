...
from wa_business_collector.chrome_session import ChromeTarget, ChromeWhatsAppSession
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="wa-business-collector")
    ...
    dashboard_export.add_argument("--account-label", default="WhatsApp Business")
...
def main(argv: Sequence[str] | None = None, *, collector: WhatsAppBusinessCollector | None = None) -> int:
    parser = build_parser()
